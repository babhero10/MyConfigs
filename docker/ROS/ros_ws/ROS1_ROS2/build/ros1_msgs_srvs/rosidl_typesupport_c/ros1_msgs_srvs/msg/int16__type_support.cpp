...
static const _Int16_type_support_symbol_names_t _Int16_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros1_msgs_srvs, msg, Int16)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros1_msgs_srvs, msg, Int16)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros1_msgs_srvs, msg, Int16)() {
  return &::ros1_msgs_srvs::msg::rosidl_typesupport_c::Int16_message_type_support_handle;
}
