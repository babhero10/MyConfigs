...
#include <stddef.h>
#include "ros1_to_ros2_package/msg/detail/int8__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  ros1_to_ros2_package__msg__Int8__init(message_memory);
}

void Int8__rosidl_typesupport_introspection_c__Int8_fini_function(void * message_memory)
{
  ros1_to_ros2_package__msg__Int8__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Int8__rosidl_typesupport_introspection_c__Int8_message_member_array[1] = {
  {
    ...
    offsetof(ros1_to_ros2_package__msg__Int8, data),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Int8__rosidl_typesupport_introspection_c__Int8_message_members = {
  ...
  "Int8",  // message name
  1,  // number of fields
  sizeof(ros1_to_ros2_package__msg__Int8),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros1_to_ros2_package, msg, Int8)() {
