...
bool ros1_msgs_srvs__msg__int8__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros1_msgs_srvs.msg._int8.Int8", full_classname_dest, 29) == 0);
  }
  ros1_msgs_srvs__msg__Int8 * ros_message = _ros_message;
  {  // data
...
PyObject * ros1_msgs_srvs__msg__int8__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros1_msgs_srvs.msg._int8");
