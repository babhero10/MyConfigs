...
#include "ros1_msgs_srvs/msg/detail/int8__rosidl_typesupport_fastrtps_c.h"
...
using _Int8__ros_msg_type = ros1_msgs_srvs__msg__Int8;
...
static uint32_t _Int8__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros1_msgs_srvs__msg__Int8(
...
{
  return max_serialized_size_ros1_msgs_srvs__msg__Int8(
    full_bounded, 0);
}
