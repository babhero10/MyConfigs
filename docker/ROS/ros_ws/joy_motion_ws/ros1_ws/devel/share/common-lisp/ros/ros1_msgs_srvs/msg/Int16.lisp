...
(cl:in-package ros1_msgs_srvs-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Int16>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Int16)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros1_msgs_srvs-msg:<Int16> is deprecated: use ros1_msgs_srvs-msg:Int16 instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <Int16>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros1_msgs_srvs-msg:data-val is deprecated.  Use ros1_msgs_srvs-msg:data instead.")
  (data m))
