...
#include "ros1_to_ros2_package/msg/detail/int8__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const ros1_to_ros2_package::msg::Int8 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros1_to_ros2_package::msg::Int8 *>(
    untyped_ros_message);
...
{
  return &ros1_to_ros2_package::msg::typesupport_fastrtps_cpp::_Int8__handle;
}
