...
ros1_msgs_srvs__msg__Int8__create()
{
  ...
  ros1_msgs_srvs__msg__Int8 * msg = (ros1_msgs_srvs__msg__Int8 *)allocator.allocate(sizeof(ros1_msgs_srvs__msg__Int8), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros1_msgs_srvs__msg__Int8));
  bool success = ros1_msgs_srvs__msg__Int8__init(msg);
  if (!success) {
...
ros1_msgs_srvs__msg__Int8__destroy(ros1_msgs_srvs__msg__Int8 * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ros1_msgs_srvs__msg__Int8__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ros1_msgs_srvs__msg__Int8__Sequence__init(ros1_msgs_srvs__msg__Int8__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros1_msgs_srvs__msg__Int8 * data = NULL;

  if (size) {
    data = (ros1_msgs_srvs__msg__Int8 *)allocator.zero_allocate(size, sizeof(ros1_msgs_srvs__msg__Int8), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros1_msgs_srvs__msg__Int8__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ros1_msgs_srvs__msg__Int8__fini(&data[i - 1]);
      }
...
ros1_msgs_srvs__msg__Int8__Sequence__fini(ros1_msgs_srvs__msg__Int8__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ros1_msgs_srvs__msg__Int8__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros1_msgs_srvs__msg__Int8__Sequence * array = (ros1_msgs_srvs__msg__Int8__Sequence *)allocator.allocate(sizeof(ros1_msgs_srvs__msg__Int8__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros1_msgs_srvs__msg__Int8__Sequence__init(array, size);
  if (!success) {
...
ros1_msgs_srvs__msg__Int8__Sequence__destroy(ros1_msgs_srvs__msg__Int8__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros1_msgs_srvs__msg__Int8__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros1_msgs_srvs__msg__Int8__Sequence__are_equal(const ros1_msgs_srvs__msg__Int8__Sequence * lhs, const ros1_msgs_srvs__msg__Int8__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros1_msgs_srvs__msg__Int8__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros1_msgs_srvs__msg__Int8__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros1_msgs_srvs__msg__Int8);
    ros1_msgs_srvs__msg__Int8 * data =
      (ros1_msgs_srvs__msg__Int8 *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros1_msgs_srvs__msg__Int8__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          ros1_msgs_srvs__msg__Int8__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros1_msgs_srvs__msg__Int8__copy(
