...
static const _Int16_type_support_symbol_names_t _Int16_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros1_to_ros2_package, msg, Int16)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros1_to_ros2_package, msg, Int16)),
  }
};
...
{
  return &::ros1_to_ros2_package::msg::rosidl_typesupport_cpp::Int16_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros1_to_ros2_package, msg, Int16)() {
  return get_message_type_support_handle<ros1_to_ros2_package::msg::Int16>();
}
